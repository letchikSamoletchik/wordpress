...
class CustomizerImporter {
	...
	public static function import_customizer_options( $import_file_path ) {
		//below code is added for context blog theme only casue it has 2 demo import design
		$activate_theme = wp_get_theme();
		$themeName  = $activate_theme->get( 'Name' );

		if( $themeName == "Context Blog" ) {
			$context_blog_option = get_option( 'theme_mods_context-blog' );
			delete_option( 'theme_mods_context-blog', $context_blog_option );
		} 
		...
		foreach ( $data['mods'] as $key => $val ) {
			...
			// this line update the theme mod
